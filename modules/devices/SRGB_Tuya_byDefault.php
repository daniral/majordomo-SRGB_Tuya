...
$this->setProperty('dayBrightness', '100');
$this->setProperty('nightBrightness', '10');
$this->setProperty('dayColor', '#FFFFFF');
$this->setProperty('nightColor', '#FFD700');
$this->setProperty('brightnessWorkMax', '254');
$this->setProperty('brightnessWorkMin', '0');